...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      {
        kind: "note",
        title: "Change the rules, change the answer",
        text: "Every rule the third pass applies is a setting you control, and the report recalculates the moment you move one.",
        href: "/nisab",
        linkLabel: "Open nisab & dates",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        text: "Gold is the default because it is the more common contemporary position, not because it is the safer one. Switching the basis reprices the threshold immediately and re-runs every year in your history against it.",
        href: "/nisab",
        linkLabel: "Switch the basis",
      },
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        text: "Rules, exclusions, liabilities and your hawl date are stored in your browser, not on a server. Clearing them is one button, and it is on the privacy page.",
        href: "/privacy",
